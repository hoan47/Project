...
namespace Project
{
    public class HotelRoom
    {
        ...
        public HotelRoom(string NameHotel, Address Address, string NameRoom, int Bedroom, int Bed, int People, TimeSpan CheckIn, TimeSpan CheckOut, DateTime DateCheckIn, DateTime DateCheckOut, string Phone, double Area, int Price, string Describe, List<string> services, List<string> amenities, List<Image_> imagesHotel, List<Image_> imagesRoom)
        {
